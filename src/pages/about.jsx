...
function About() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#4d0a6ccd] to-[#000000] flex items-center justify-center px-6">
      <div className="max-w-3xl text-center bg-[#ede6efcd] p-10 rounded-3xl shadow-2xl border border-gray-200">
